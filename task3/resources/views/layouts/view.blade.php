    ...
    <body>
        ...
        <div class="navbar navbar-inverse">
            <div class="navbar-header">
                <a class="navbar-brand" href="#"><strong>MEDICO</strong></a>
        ...
        <div class="page-container">
            ...
            <div class="footer text-muted">
                &copy; {{date("Y")}}. <a href="http://www.medicoorg.com/">Medico</a> by <a href="http://novuscode.com" target="_blank">Novuscode</a>
            </div>
            <!-- /footer -->
        </div>
